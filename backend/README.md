...
## Project Structure
    ...
    ├── testapiautoteammemb_77460  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_77460`
...
2. Clone this repo and `cd testapiautoteammemb_77460`
